            ...
            <div className={styles.container}>
                ...
                <div className={styles.contactSection}>
                    <div className={styles.contactHeader}>
                        <h2>Precisa de Ajuda ou Quer dar Feedback?</h2>
                        <p>Junte-se à nossa comunidade ou envie-nos uma mensagem direta.</p>
                    </div>

                    <div className={styles.contactCards}>
                        <a href="https://discord.gg/yourdiscordlink" target="_blank" rel="noopener noreferrer" className={`${styles.contactCard} ${styles.discordCard}`}>
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <span>Tire dúvidas e interaja em tempo real.</span>
                            </div>
                        </a>
                        ...
                        <div
                            ...
                            onKeyDown={(e) => { if (e.key === 'Enter') handleEmailClick(e); }}
                            role="button"
                            tabIndex={0}
